...
@app.route('/category/<int:category_id>/item/<int:item_id>/edit', methods=[
    'GET', 'POST'])
def editItem(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        if request.form['section']:
            editedItem.section = request.form['section']
...
# Delete an item
@app.route('/category/<int:category_id>/item/<int:item_id>/delete', methods=[
    'GET', 'POST'])
